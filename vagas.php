...
include 'navbar.php';
  ...
  $sql1 = $mysqli->prepare('select v.id,u.nome,e.responsavel,v.descricao,v.questionario_id,q.titulo,v.dt_cad,v.dt_ini,v.dt_fim from vaga as v,usuario as u,empresa as e,questionario as q where v.empresa_id = e.usuario_id and e.usuario_id = u.id and q.id = v.questionario_id and v.empresa_id = ?  ');
